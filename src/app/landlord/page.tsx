...
export default function LandlordDashboard() {
  const statsCards = [
    { label: "Total Properties", value: "0", icon: Building2, color: "text-blue-500", bg: "bg-blue-500/10", border: "border-blue-500/20", trend: "+0% this month" },
    { label: "Active Units", value: "0", icon: Layers, color: "text-green-500", bg: "bg-green-500/10", border: "border-green-500/20", trend: "+0% this month" },
    { label: "Total Views", value: "0", icon: Eye, color: "text-amber-500", bg: "bg-amber-500/10", border: "border-amber-500/20", trend: "+0% this week" },
  ];
